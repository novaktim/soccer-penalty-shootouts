...
########################################################################################################################
##### Scrape all cup match results - Warning: can take sometime, can also skip this and load pre-scraped data  ########
########################################################################################################################
...
########################################################################################################################
##### Go through all scraped game histories to find those which ended in a penalty shootout ############################
########################################################################################################################
...
# TODO maybe plot it
# looks possibly correct
# Not starting the shootout seems to lead to more decisive shots
...
ggplot(success_rates, aes(
  ...
  coord_flip()
#ggsave("Difference from Mean by Leageu and Gender.png")
